...
def align_after_image(
  ...
  return aligned_after, row_shift, col_shift
...
class GenerateExamplesFn(beam.DoFn):
  ...
  def _create_example(
    ...
    if self._use_before_image and self._use_after_image:
      after_image, alignment_row_shift, alignment_col_shift = align_after_image(
          before_image, after_image
      )
      post_footprint_x_shift_meters = alignment_col_shift * self._resolution
      # Row indexes increase going downward, while Y values increase going
      # upward. So Y shift is the negative of the row shift.
      post_footprint_y_shift_meters = -alignment_row_shift * self._resolution
