...
def _decode_skai_record_bytes(
  ...
  Returns:
    dict that represent an example in SKAI dataset.
  """
  features_to_read = {
  ...
  if (not use_post_disaster_only) and load_small_images:
    features_to_read.update({
...
def get_skai_dataloader_from_tfrecord(config: ml_collections.ConfigDict):
