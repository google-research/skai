...
def get_training_config():
  ...
  # TODO(jlee24): Allow user to specify early stopping patience.
...
def get_model_config():
  ...
  # TODO(jlee24): Debug why loading ImageNet weights causes model train/val
...
def get_upsampling_config():
  ...
  # TODO(jlee24): Add support for upsampling signal being bias or error.
