...
_NUM_CPU = flags.DEFINE_integer('num_cpu', 8, 'Number of CPUs to use.')

_NUM_RAM = flags.DEFINE_integer('num_ram', 64, 'Number of RAM to use.')
  ...
  with xm_local.create_experiment(
    ...
    if _BUILD_DOCKER_IMAGE.value:
      ...
      if _MODEL_TYPE.value == 'siglip':
        ...
        assert _ACCELERATOR.value == 'A100', 'Only A100 is supported for GeoFM.'
        accelerator = 'geofm-gpu'
      else:
    ...
    if _MODEL_TYPE.value == 'siglip' or _MODEL_TYPE.value == 'geofm':
